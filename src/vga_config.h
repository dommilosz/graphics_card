...
#if LAYERS==1
#define VGA_SMALL	_1LS0	// mask of all state machines
#elif LAYERS==2
#define VGA_SMALL	(_1LS0+_1LS1) // mask of all state machines
#elif LAYERS==3
#define VGA_SMALL	(_1LS0+_1LS1+_1LS2) // mask of all state machines
#elif LAYERS==4
#define VGA_SMALL	(_1LS0+_1LS1+_1LS2+_1LS3) // mask of all state machines
#else
#error Unsupported number of layers!
#endif
