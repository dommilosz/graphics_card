...
void GenPal4Plane(u32* trans, const u8* pal)
{
	...
	{
		j = 0;
		if ((i & _1LS7) != 0) j |= _1LS1;
		if ((i & _1LS3) != 0) j |= _1LS0;
		k = pal[j];

		j = 0;
		if ((i & _1LS6) != 0) j |= _1LS1;
		if ((i & _1LS2) != 0) j |= _1LS0;
		k |= (u32)pal[j] << 8;

		j = 0;
		if ((i & _1LS5) != 0) j |= _1LS1;
		if ((i & _1LS1) != 0) j |= _1LS0;
		k |= (u32)pal[j] << 16;

		j = 0;
		if ((i & _1LS4) != 0) j |= _1LS1;
		if ((i & _1LS0) != 0) j |= _1LS0;
		k |= (u32)pal[j] << 24;
